...
function Signup() {
    ...
    return (
        <body className='admin-body' style={{ backgroundImage: `url(/images/background_img.jpg)` }}>
                    ...
                    <form className="pb-3" onSubmit={handleSubmit}>
                        ...
                        <div className="form-row mt-4">
                            <div className="form-group col-md-12">
                                ...
                                <input type="text" name="email" className="form-control form-input" id="username"
                        ...
                        <div className="form-row mt-2">
                            <div className="form-group col-md-12">
                                <label htmlFor="user_password" className="form-label">Confirm Password</label>
                                <input type="password" name="CPassword" autoComplete="off" className="form-control form-input" id="user_password_confirm"
