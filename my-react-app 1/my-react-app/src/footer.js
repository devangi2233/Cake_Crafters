            ...
            <footer className="footer">
                ...
                <div className="container">
                    <div className="row p-4">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-12 pl-3 pr-3 pb-3">
                        <h5 class="mb-3">Category</h5>
                        <ul>
                            <li class="mb-2"><a class="footer-link" href="#"><i class="fa-solid fa-angles-right pr-2"></i>Choclate</a>
                            </li>
                            <li class="mb-2"><a class="footer-link" href="#"><i class="fa-solid fa-angles-right pr-2"></i>Pineapple</a>
                            </li>
                            <li class="mb-2"><a class="footer-link" href="#"><i class="fa-solid fa-angles-right pr-2"></i>Themed</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-12 pl-3 pr-3 pb-3">
                        ...
                        <ul>
                            <li class="mb-2"><a class="footer-link" href="#"><i class="fa-solid fa-angles-right pr-2"></i>Bomb Cake</a>
                            </li>
                            <li class="mb-2"><a class="footer-link" href="#"><i class="fa-solid fa-angles-right pr-2"></i>Fondant Cake</a></li>
                            <li class="mb-2"><a class="footer-link" href="#"><i class="fa-solid fa-angles-right pr-2"></i>Lava Cake</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-12 pl-3 pr-3 pb-3">
                        ...
                        <ul>
                            <li class="mb-2"><a class="footer-link" href="#"><i class="fa-solid fa-angles-right pr-2"></i>+91 123456789</a>
                            </li>
                            <li class="mb-2"><a class="footer-link" href="#"><i class="fa-solid fa-angles-right pr-2"></i>cakecrafters@gmail.com</a>
                            </li>
                        </ul>
                    </div>
                    </div>
